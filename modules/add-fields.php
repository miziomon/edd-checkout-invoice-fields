...
add_action('edd_purchase_form_user_info', function () {
   ...
   <p>
        ...
        <span class="edd-description"><?php _e('Your Fiscal code (only if is different from VAT or you don\'t heve VAT)', 'edd_cif'); ?></span>
		<input class="edd-input required" name="edd_fc" id="edd-fc" placeholder="<?php _e('Fiscal code', 'edd_cif'); ?>" value="" type="text" >
    </p>    
    <p>
